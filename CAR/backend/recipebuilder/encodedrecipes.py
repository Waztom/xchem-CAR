encoded_recipes = {
    "Amidation": {
        ...
        "recipes": {
            "Standard": {
                "reference": ["https://pubs.acs.org/doi/pdf/10.1021/acs.oprd.0c00289"],
                "actions": [
                    {
                        "name": "add",
                        "content": {
    ...
    "Amide schotten - baumann": {
        "reactionSMARTS": ["[#6:1](=[#8:2])-[#17].[#7;H2,H1:3]>>[#6:1](=[#8:2])-[#7:3]"],
        "recipes": {
            "Standard": {
                "reference": None,
                "actions": [
        ...
        "recipes": {
            "SNAr Base": {
                "reference": [
                    ...
                    "https://chemistry-europe.onlinelibrary.wiley.com/doi/10.1002/cmtd.202000051",
                ],
                "actions": [
                    {
                        "name": "add",
                        "content": {
                            ...
                            "material": {
                                ...
                                "quantity": {
                                    "value": 4,
                                    "unit": "moleq",
                                },  # based off of virtual optimisation
                                "solvent": "NMP",
                                "concentration": 0.5,
                            },
                        },
    ...
    "sp2-sp2 suzuki coupling": {
        ...
        "recipes": {
            "XphosPdG3-Suzuki": {
                "reference": [
                    "https://chemistry-europe.onlinelibrary.wiley.com/doi/full/10.1002/chem.201801165"
                ],
                "actions": [
                    {
                        "name": "add",
