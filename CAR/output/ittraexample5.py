...
# ittraexample5 for "Example Author" produced by XChem Car (https://car.xchem.diamond.ac.uk)
# metadata
 metadata = {
	'protocolName': 'ittraexample5',
...
def run(protocol: protocol_api.ProtocolContext):
	...
	1.pick_up_tip()
	1.aspirate(5.0, OrderPlate[0])
	1.dispense(5.0, ReactionPlate[0])
	1.drop_tip()
	...
	# move - 10.0ul from OrderPlate[2] to ReactionPlate[0]
	1.pick_up_tip()
	1.aspirate(10.0, OrderPlate[2])
