"""Tests for the plate visualizer and transfer record modules.

Tests for:
  - TransferRecord     (transfer_mode field, dataclass defaults)
  - TransferLedger     (recording with transfer_mode passthrough)
  - PlateVisualizer    (multichannel annotations on wells, legend, transfer
...
def _make_visualizer(wells, ledger_records=None):
    """Build a PlateVisualizer with mocked dependencies."""
    from backend.opentrons.otwriter.plate_visualizer import PlateVisualizer
    from backend.opentrons.otwriter.transfer_record import TransferLedger
    ...
    with patch("backend.models.Well") as MockWell:
        ...
        viz = PlateVisualizer(sg)

    return viz


# ===================================================================
# PlateVisualizer – multichannel annotations
# ===================================================================

class TestPlateVisualizerMultichannel(TestCase):
    """Tests for MC annotations in PlateVisualizer."""
...
class TestTransferSummariesMultichannel(TestCase):
    ...
    def test_mc_tag_in_summary(self):
        ...
        result = PlateVisualizer._transfer_summaries([rec], "in")
